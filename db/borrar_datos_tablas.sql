...
-- 2. Borramos el contenido de TODAS las tablas sin restricciones
DELETE FROM afiliados_bajas;
...
-- 3. Reiniciamos los contadores (Auto_Increment) a 1
ALTER TABLE afiliados_bajas AUTO_INCREMENT = 1;
