...
<head>
    ...
    <style>
        ...
        h2 { font-family: 'Montserrat', sans-serif; color: #19248B; font-weight: 700; }
        .navbar-custom { background-color: #19248B; }
        .table-custom th { background-color: #19248B; color: white; }
        .btn-completar { background-color: #19248B; color: white; border: none; }
        .btn-completar:hover { background-color: #3a4dbd; color: white; }
                        ...
                        <tbody>
                            ...
                            <tr v-for="solicitud in solicitudes" :key="solicitud.id">
                                ...
                                <td class="text-center">
                                    <a :href="'../../ficha_afiliacion.php?id_solicitud=' + solicitud.id" class="btn btn-sm btn-completar">
                                        ✍️ Completar Ficha
                                    </a>
                                </td>
                            </tr>
